...
public class DatabaseHandler extends SQLiteOpenHelper{
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        //Create a new table in case of an upgrade
        onCreate(db);
    ...
    public void addFood(Food food){
        ...
        Log.d("Added food item", "YESS ITS ADDED ");
        dba.close();
    ...
    public ArrayList<Food> getFoods(){
        //Returning everything from the Database as a ArrayList
        foodList.clear();

        SQLiteDatabase dba = this.getReadableDatabase();
        Cursor cursor  = dba.query(Constants.TABLE_NAME, new String[]{Constants.KEY_ID,
        Constants.FOOD_NAME, Constants.FOOD_CALORIES_NAME, Constants.DATE_NAME}, null, null, null, null,
